...
-- Colemak setup
-- better up/down
map({ "n", "x" }, "n", "v:count == 0 ? 'gj' : 'j'", { expr = true, silent = true, desc = "Colemak down" })
map({ "n", "x" }, "e", "v:count == 0 ? 'gk' : 'k'", { expr = true, silent = true, desc = "Colemak up" })
map({ "n", "x" }, "m", "h", { desc = "Colemak left" })
map({ "n", "x" }, "i", "l", { desc = "Colemak right" })

map({ "n", "x" }, "k", "e", { desc = "Colemak end" })
map({ "n", "x" }, "j", "m", { desc = "Colemak mark/set" })
map({ "n" }, "l", "i", { desc = "Colemak insert" })
...
map("n", "h", "'Nn'[v:searchforward]", { expr = true, desc = "Next search result" })
map("x", "h", "'Nn'[v:searchforward]", { expr = true, desc = "Next search result" })
map("o", "h", "'Nn'[v:searchforward]", { expr = true, desc = "Next search result" })
map("n", "H", "'nN'[v:searchforward]", { expr = true, desc = "Prev search result" })
map("x", "H", "'nN'[v:searchforward]", { expr = true, desc = "Prev search result" })
map("o", "H", "'nN'[v:searchforward]", { expr = true, desc = "Prev search result" })
...
-- TODO: This does not seem to work, enter leads to weird behavior
-- map("t", "<C-m>", "<cmd>wincmd h<cr>", { desc = "Go to left window" })
-- map("t", "<C-n>", "<cmd>wincmd j<cr>", { desc = "Go to lower window" })
-- map("t", "<C-e>", "<cmd>wincmd k<cr>", { desc = "Go to upper window" })
